...
The active vNext 2026-05.7 framework includes COMPASS-only terminology, career-focused scope, COMPASS Intake checkpoint artifact behavior, COMPASS Source Rebase scaffold alignment, and Initial Seed Artifact support:
