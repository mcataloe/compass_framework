...
- search-breadth targets, mandatory surfaces, named-source rosters, approved substitutions, rotation windows, query bundles, source and title-family coverage, expansion-pass limits, and no-yield stopping thresholds;
